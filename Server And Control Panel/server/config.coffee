...
module.exports =
  ...
  videoControlReceiverPort: 20000 + 2
  audioControlReceiverPort: 20000 + 3
  videoDataReceiverPort   : 20000 + 4
  audioDataReceiverPort   : 20000 + 5
  ...
  audioRTPServerPort : 20000 + 6  # even
  audioRTCPServerPort: 20000 + 7  # odd and contiguous
  videoRTPServerPort : 20000 + 8  # even
  videoRTCPServerPort: 20000 + 9  # odd and contiguous
  ...
  rtspVideoDataUDPListenPort   : 20000 + 10
  rtspVideoControlUDPListenPort: 20000 + 11
  rtspAudioDataUDPListenPort   : 20000 + 12
  rtspAudioControlUDPListenPort: 20000 + 13
