...
module.exports =
  ...
  videoControlReceiverPort: "$1 + 2"
  audioControlReceiverPort: "$1 + 3"
  videoDataReceiverPort   : "$1 + 4"
  audioDataReceiverPort   : "$1 + 5"
  ...
  audioRTPServerPort : "$1 + 6"  # even
  audioRTCPServerPort: "$1 + 7"  # odd and contiguous
  videoRTPServerPort : "$1 + 8"  # even
  videoRTCPServerPort: "$1 + 9"  # odd and contiguous
  ...
  rtspVideoDataUDPListenPort   : "$1 + 10"
  rtspVideoControlUDPListenPort: "$1 + 11"
  rtspAudioDataUDPListenPort   : "$1 + 12"
  rtspAudioControlUDPListenPort: "$1 + 13"
