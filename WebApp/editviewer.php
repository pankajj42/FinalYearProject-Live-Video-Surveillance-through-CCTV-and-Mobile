<?php
										...
										<table class="table table-bordered table-striped table-condensed">
											<div class="container-fluid">
												<div class="animated fadeIn">
													<div class="card">
														<div class="card-block">';
															$result = mysqli_query($conn,"SELECT * FROM viewers where username = '".$choice."'");
															...
															<form method="post" class="form-horizontal ">
																...
																<div class="card-footer">
																	<input type="submit" name="addc" class="btn btn-sm btn-primary" value="Edit Viewer">
																</div>
															</form>';
															echo '
														</div>
	...
	if(isset($_POST['addc'])){
				...
				if($pass == "")
				{
					$result = mysqli_query($conn,"UPDATE viewers SET phone = '".$phone."' where username = '".$choice."'");
				}
				
				else{
					
					$shapass = sha1($pass);
					$result = mysqli_query($conn,"UPDATE viewers SET password = '".$shapass."', phone = '".$phone."' where username = '".$choice."'");
				}
					if($result){
						render("Successful");
					}
