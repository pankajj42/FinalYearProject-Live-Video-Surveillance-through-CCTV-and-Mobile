												...
												while($run = mysqli_fetch_assoc($result)){
													echo '
														<tr>
															...
															<td>'.$run['phone'].'</td>
															<td style="text-align:center">
															<button class="btn_view" id="'.$run['username'].'" onclick="viewerPage(this.id)" >View Info</button>
															<button class="btn_edit" id="'.$run['username'].'" onclick="editVPage(this.id)">Edit</button>
															</td>
														</tr>';
												}
											}
