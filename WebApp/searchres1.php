...
<div class="pace-activity"></div></div>
													...
													echo '
														<tr>
															...
															<td style="text-align:center">
																...
																<button class="btn_edit" id="'.$run['username'].'" onclick="editPage(this.id)">Edit</button>
															</td>
														</tr>
														';
												}
		...
		<script>
			...
			{
				document.location.href = "viewInfo.php?choice="+id;
			}
			function editPage(id)
			{
			document.location.href = "edit.php?choice="+id;
			}
			function viewerPage(id)
			{
				document.location.href = "viewerInfo.php?choice="+id;
			}
			function editVPage(id)
			{
			document.location.href = "editViewer.php?choice="+id;
			}
		</script>
