<?php
																	...
																	<div class="card-block">
																		<form method="post" class="form-horizontal ">
																			...
																			<div class="card-footer">
																				<input type="submit" name="addv" class="btn btn-sm btn-primary" value="Add Viewer">
																			</div>
																		</form>
																	</div>
																</div>
	...
	if(isset($_POST['addv'])){
				...
				{
					$shapass = sha1($pass);
					$result = mysqli_query($conn,"INSERT INTO viewers VALUES('$user','$shapass','$phone')");
						if($result){
							render("Successful");
						}
					else{
