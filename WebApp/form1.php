<?php
																	...
																	<div class="card-block">
																		<form method="post" class="form-horizontal ">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-md-9">
																					<input type="number" id="hf-rooms" name="hf-rooms" autocomplete="off" class="form-control" placeholder="Enter Number Of Rooms..">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-md-9">
																					<input type="number_format" id="hf-phone" name="hf-phone" autocomplete="off" class="form-control" placeholder="Enter Phone Number..">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-md-9">
																					<input type="number_format" id="hf-name" name="hf-name" autocomplete="off" class="form-control" placeholder="Enter School Name..">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-md-9">
																					<input type="number_format" id="hf-address" name="hf-address" autocomplete="off" class="form-control" placeholder="Enter School Address..">
																					<span class="help-block">Please enter your address of the school</span>
																				</div>
																			</div>
																			<p style="color:red; size:12px">'.$error.'</p>
																			<div class="card-footer">
																				<input type="submit" name="addc" class="btn btn-sm btn-primary" value="Add Centre">
																			</div>
																		</form>
																	</div>
																</div>
	...
	if(isset($_POST['addc'])){
				...
				if(empty($user) || empty($pass) || empty($roomn) || empty($phone) || empty($name) || empty($address))
				{
				...
				{
					$shapass = sha1($pass);
					$result = mysqli_query($conn,"INSERT INTO centres VALUES('$user','$shapass','$name','$phone','$roomn','$address')");
					$count = 0;
					$port = 9000;
					for($i=0;$i<$roomn;$i++)
					{
						...
						$x = "Room_".($i+1);
						$res = mysqli_query($conn,"INSERT INTO streams VALUES('NULL','$user',0,'$x','$port')");
						$port+=100;
						$count++;
					}
					if($result && $res){
